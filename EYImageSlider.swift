 ...
 public class EYImageSlider: UIView, UIScrollViewDelegate {
    ...
    /// Delegates
    var dataSource: EYImageSliderDataSource!
    var delegate: EYImageSliderDelegate?
    var imageSource: EYImageSliderImageDataSource?
    ...
    var imageCounterDisabled = false {
        didSet(newValue) {
            if newValue {
    ...
    var hidePageControlForSinglePages = true {
        didSet {
    ...
    /// Slide show
    var slideShowTimeInterval: NSTimeInterval = 0.0 {
        didSet {
    ...
    var slideShowShouldCallScrollToDelegate = true
    
    /// Caption label
    var captionTextColor: UIColor = UIColor.blackColor() {
        didSet {
            captionLabel.textColor = captionTextColor
        }
    }
    
    var captionBackgroundColor = UIColor.clearColor() {
        didSet {
            captionLabel.backgroundColor = captionBackgroundColor
        }
    }
    
    var captionFont = UIFont.systemFontOfSize(12) {
        didSet {
